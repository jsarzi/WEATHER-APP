...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getWeatherControllerService()
    {
        ...
        $this->services['App\\Controller\\WeatherController'] = $instance = new \App\Controller\WeatherController(new \App\Service\WeatherService($this->getEnv('WEATHER_API_KEY')));
